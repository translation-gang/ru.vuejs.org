...
- **Props:**
  - `include` — строка или регулярное выражение или массив. Только соответствующие компоненты будут кешироваться.
  - `exclude` — строка или регулярное выражение или массив. Все соответствующие компоненты не будут кешироваться.
