...
- **Подробности:**
  ...
  **Примечание:** `v-slot:foo` подерживается в версии v2.6+. Для более старых версий вы можете использовать [устаревший синтаксис](../guide/components-slots.html#Устаревший-синтаксис).
