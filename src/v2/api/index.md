...
- **Пример:**
  ...
  Обратите внимание, если вы используете стрелочную функцию в свойстве `data`, то `this` будет undefined, но вы можете получить доступ к экземпляру из первого аргумента функции:
...
- **Подробности:**
  ...
  Обратите внимание, если вы используете стрелочную функцию в вычисляемом свойстве, то `this` будет undefined, но вы можете получить доступ к экземпляру из первого аргумента функции:
