...
- **Пример:**
  ...
  <!-- обработчик события click будет вызван не больше одного раза -->
...
- **Использование:**
  ...
  Эта директива останется на элементе до тех пор, пока связанный с ним инстанс Vue не закончит компиляцию. Если добавить CSS-правило вроде `[v-cloak] { display: none }`, этой директивой можно прятать нескомпилированные шаблоны до тех пор, пока инстанс Vue не будет готов.
...
- **См. также:** [Дистрибьюция контента через слоты](../guide/components.html#Дистрибьюция-контента-через-слоты)
