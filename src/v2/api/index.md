...
- **Подробности:**
  ...
  <p class="tip">Динамический рендеринг произвольного HTML-кода на сайте — это очень опасная практика, так как легко приводит к [XSS-атакам](https://en.wikipedia.org/wiki/Cross-site_scripting). Передавайте в `v-html` только содержимое, которому можно доверять, и **никогда** не передавайте сюда ничего предоставленного пользователями.</p>
