...
<p class="tip">Помните, что использование этого компонента означает то, что хуки жизненного цикла не будут вызываться. Посетите документацию по Vue Router, чтобы узнать больше о [динамических путях](https://v3.router.vuejs.org/ru/guide/essentials/dynamic-matching.html)</p>
