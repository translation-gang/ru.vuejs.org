...
<div class="vueschool"><a href="https://vueschool.io/lessons/reusable-components-with-props?friend=vuejs" target="_blank" rel="sponsored noopener" title="Узнайте, как работать с входными параметрами компонентов в бесплатном уроке Vue School">Узнайте, как работать с входными параметрами компонентов в бесплатном уроке Vue School</a></div>
