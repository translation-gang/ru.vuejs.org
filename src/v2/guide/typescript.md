...
// tsconfig.json
{
  "compilerOptions": {
    ...
    "target": "es5",
    // это обеспечивает более строгий вывод для свойство данных на `this`
    "strict": true,
...
Обратите внимание, что при использовании Vetur с однофайловыми компонентами, вывод типов будет автоматически применён к экспорту по умолчанию, поэтому нет необходимости оборачивать его в `Vue.extend`:
