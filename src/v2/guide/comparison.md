...
Впрочем, если вам лень этим заниматься, вот цифры, полученные при запуске бенчмарка в Chrome 52 на MacBook Air 2014. Таблица обобщает результаты 20 запусков теста:
