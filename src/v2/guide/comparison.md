...
Впрочем, если вам лень этим заниматься, вот цифры, полученные при запуске бенчмарка в Chrome 52 на MacBook Air 2014. Таблица обобщает результаты 20-ти запусков теста:
...
Разумеется, производительность в production важнее всего, поскольку именно она влияет на опыт конечных пользователей при взаимодействии с приложением. Но и при разработке быстродействие имеет немалое значение.
