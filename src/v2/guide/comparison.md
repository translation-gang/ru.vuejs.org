...
Разумеется, производительность в production важнее всего, поскольку именно она влияет на качество опыта конечных пользователей при взаимодействии с приложением. Но и во время разработки быстродействие используемого фреймворка имеет немалое значение.
