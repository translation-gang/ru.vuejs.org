...
Когда вы&nbsp;изменяете число, это изменение в&nbsp;элементе под полем ввода анимируется. Для демонстрации&nbsp;&mdash; неплохо, но&nbsp;как насчёт параметров, которые напрямую как числа не&nbsp;хранятся, например таких как CSS-цвета? Используя Color.js, мы&nbsp;можем решить эту задачу:
