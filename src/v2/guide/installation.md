...
- **[ES Module](http://exploringjs.com/es6/ch_modules.html)**: сборки в виде ES-модулей предназначены для использования с современными инструментами сборки, такими как [Webpack 2](https://webpack.js.org) или [Rollup](https://rollupjs.org/). По умолчанию для них (`pkg.module`) будет сборка ES Module Runtime-only (`vue.runtime.esm.js`).
