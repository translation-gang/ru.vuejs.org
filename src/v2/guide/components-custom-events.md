...
<div class="vueschool"><a href="https://vueschool.io/lessons/communication-between-components?friend=vuejs" target="_blank" rel="sponsored noopener" title="Узнайте, как работать с пользовательскими событиями в бесплатном уроке Vue School">Узнайте, как работать с пользовательскими событиями в бесплатном уроке Vue School</a></div>
...
Vue.component('base-input', {
  ...
  computed: {
    inputListeners: function () {
      ...
      // Таким образом мы расширяем стандарные слушатели на компоненте
      return Object.assign({},
        ...
        {
          // Обеспечивает поддержку для функционала v-model на компоненте
...
Мы расширили свойство `$listeners` компонента, добавив в него событие input нашего input'a, который не являлся корневым элементом. 
