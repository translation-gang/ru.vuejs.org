...
<p class="tip">Динамические выражения аргументов имеют синтаксические ограничения, потому что некоторые символы недопустимы в именах атрибутов HTML, такие как пробелы и кавычки. Также стоит избегать верхнего регистра если указываете шаблоны в DOM.</p>
...
Кроме того, если вы указываете шаблоны в DOM (шаблоны, написанные непосредственно в HTML-файле), вы должны не забывать, что браузеры приводят имена атрибутов в нижний регистр:
