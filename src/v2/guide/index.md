...
<div class="scrimba"><a href="https://scrimba.com/p/pXKqta/cQ3QVcr" target="_blank">Пройдите этот урок на Scrimba</a></div>
...
<div class="scrimba"><a href="https://scrimba.com/p/pXKqta/cEQe4SJ" target="_blank">Пройдите этот урок на Scrimba</a></div>
...
<div class="scrimba"><a href="https://scrimba.com/p/pXKqta/czPNaUr" target="_blank">Пройдите этот урок на Scrimba</a></div>
...
<div class="scrimba"><a href="https://scrimba.com/p/pXKqta/cEQVkA3" target="_blank">Пройдите этот урок на Scrimba</a></div>
...
1. Спецификация Web Components ещё находится в статусе черновика и не реализована ни в одном из браузеров. Компоненты Vue, напротив, не требуют никаких полифилов и работают во всех поддерживаемых браузерах (IE9 и выше). При необходимости компоненты Vue могут быть «обёрнуты» в нативные пользовательские элементы.
