...
### Фрагментированные экзмепляры <sup>удалены</sup>

Каждый компонент должен содержать только один корневой элемент. Фрагментированные экзмепляры больше не используются. Если ваш шаблон выглядит следующим образом:
