...
Альтернативным образом, можно просто использовать метод, в случае если вычислимые свойства не пригодны к потреблению (например, внутри вложенных циклов `v-for`):
