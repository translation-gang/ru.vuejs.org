...
Поскольку `$nextTick()` возвращает promise, вы можете достичь того же используя новый синтаксис [ES7 async/await](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function):
 ```js
  // ...
  methods: {
