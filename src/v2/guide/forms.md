...
<p class="tip">Для `v-model` не имеет изначальное значение элемента input или textarea. В качестве источника истины всегда рассматривается только состояние экземпляра Vue.</p>
