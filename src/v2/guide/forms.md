...
<p class="tip">Для `v-model` не имеет значения изначальное состояние элемента input или textarea. В качестве источника истины всегда рассматривается только состояние экземпляра Vue.</p>
