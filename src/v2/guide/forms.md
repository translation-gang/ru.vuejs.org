...
Вы можете использовать директиву `v-model` длядвунаправленного связывания с элементами форм input и textarea. Корректный способ обновления элемента выбирается автоматически в зависимости от типа элемента. Несмотря на слегка волшебный вид, `v-model` в действительности представляет собой всего лишь синтаксический сахар для обновления данных в элементах ввода данных пользователем, с некоторыми поправками в ряде краевых случаев.
