...
- **Использование:**
  ...
  Применяет миксин ко всем созданным впоследствии инстансам Vue. Авторы плагинов могут таким образом встроить желаемое поведение в компоненты. **Не рекомендуем использовать в коде приложений**.
...
- **Подробности:**
  ...
  После создания инстанса, оригинал объекта с данными доступен как `vm.$data`. Инстанс Vue также проксирует все свойства, обнаруженные в объекте data, так что `vm.a` эквивалентно `vm.$data.a`.
